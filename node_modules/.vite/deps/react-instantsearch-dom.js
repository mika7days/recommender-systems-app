  ...
  "node_modules/algoliasearch-helper/src/SearchParameters/index.js"(exports, module) {
    ...
    SearchParameters.prototype = {
      ...
      getHierarchicalFacetByName: function(hierarchicalFacetName) {
        return find3(this.hierarchicalFacets, function(f) {
    ...
    (function() {
      ...
      function parseValue(arg) {
        ...
        if (Array.isArray(arg)) {
          return classNames22.apply(null, arg);
        }
...
var Link = function(_Component) {
  _inherits5(Link2, _Component);
  var _super = _createSuper5(Link2);
  function Link2() {
    var _this;
    _classCallCheck5(this, Link2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
    _defineProperty28(_assertThisInitialized5(_this), "onClick", function(e) {
      if (isSpecialClick(e)) {
        return;
      }
      _this.props.onClick();
  ...
  _createClass5(Link2, [{
    key: "render",
    value: function render() {
      return import_react8.default.createElement("a", _extends4({}, this.props, {
...
_defineProperty28(Link, "propTypes", {
...
var cx2 = createClassNames("Breadcrumb");
var itemsPropType = import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
  label: import_prop_types19.default.string.isRequired,
  value: import_prop_types19.default.string.isRequired
}));
var Breadcrumb = function(_Component) {
  _inherits6(Breadcrumb2, _Component);
  var _super = _createSuper6(Breadcrumb2);
  function Breadcrumb2() {
    _classCallCheck6(this, Breadcrumb2);
    return _super.apply(this, arguments);
  }
  _createClass6(Breadcrumb2, [{
    key: "render",
    value: function render() {
      ...
      var rootPath = canRefine ? import_react9.default.createElement("li", {
        className: cx2("item")
      }, import_react9.default.createElement(Link, {
        className: cx2("link"),
      ...
      var breadcrumb = items4.map(function(item, idx) {
        ...
        return import_react9.default.createElement("li", {
          className: cx2("item", isLast && "item--selected"),
          key: idx
        }, import_react9.default.createElement("span", {
          className: cx2("separator")
        }, separator), !isLast ? import_react9.default.createElement(Link, {
          className: cx2("link"),
          onClick: function onClick() {
      ...
      }, import_react9.default.createElement("ul", {
        className: cx2("list")
      }, rootPath, breadcrumb));
    }
  }]);
...
_defineProperty29(Breadcrumb, "propTypes", {
  canRefine: import_prop_types19.default.bool.isRequired,
  createURL: import_prop_types19.default.func.isRequired,
  items: itemsPropType,
  refine: import_prop_types19.default.func.isRequired,
  rootURL: import_prop_types19.default.string,
  separator: import_prop_types19.default.node,
  translate: import_prop_types19.default.func.isRequired,
  className: import_prop_types19.default.string
});
_defineProperty29(Breadcrumb, "defaultProps", {
  rootURL: null,
  separator: " > ",
  className: ""
});
...
var cx3 = createClassNames("Panel");
var _createContext2 = (0, import_react10.createContext)(function setCanRefine() {
});
var PanelConsumer = _createContext2.Consumer;
var PanelProvider = _createContext2.Provider;
var Panel = function(_Component) {
  _inherits7(Panel2, _Component);
  var _super = _createSuper7(Panel2);
  function Panel2() {
    var _this;
    _classCallCheck7(this, Panel2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
    ...
    _defineProperty30(_assertThisInitialized7(_this), "setCanRefine", function(nextCanRefine) {
      _this.setState({
  ...
  _createClass7(Panel2, [{
    ...
    value: function render() {
      ...
      }, header && import_react10.default.createElement("div", {
        className: cx3("header")
      }, header), import_react10.default.createElement("div", {
        className: cx3("body")
      }, import_react10.default.createElement(PanelProvider, {
        value: this.setCanRefine
      }, children)), footer && import_react10.default.createElement("div", {
        className: cx3("footer")
      }, footer));
    }
  }]);
  return Panel2;
}(import_react10.Component);
_defineProperty30(Panel, "propTypes", {
  children: import_prop_types20.default.node.isRequired,
  className: import_prop_types20.default.string,
  header: import_prop_types20.default.node,
  footer: import_prop_types20.default.node
});
_defineProperty30(Panel, "defaultProps", {
  className: "",
  header: null,
  footer: null
});
...
var PanelCallbackHandler = function(_Component) {
  _inherits8(PanelCallbackHandler2, _Component);
  var _super = _createSuper8(PanelCallbackHandler2);
  function PanelCallbackHandler2() {
    _classCallCheck8(this, PanelCallbackHandler2);
    return _super.apply(this, arguments);
  }
  _createClass8(PanelCallbackHandler2, [{
    key: "componentDidMount",
    value: function componentDidMount() {
...
_defineProperty31(PanelCallbackHandler, "propTypes", {
  children: import_prop_types21.default.node.isRequired,
  canRefine: import_prop_types21.default.bool.isRequired,
  setCanRefine: import_prop_types21.default.func.isRequired
});
var PanelWrapper = function PanelWrapper2(_ref7) {
  var canRefine = _ref7.canRefine, children = _ref7.children;
  return import_react11.default.createElement(PanelConsumer, null, function(setCanRefine2) {
    return import_react11.default.createElement(PanelCallbackHandler, {
